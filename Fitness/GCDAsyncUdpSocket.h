...
- (void)doReceiveEOF;
- (void)doReceive;
- (void)setReceiveFilter:(CDUnknownBlockType)arg1 withQueue:(struct dispatch_queue_s *)arg2 isAsynchronous:(BOOL)arg3;
...
- (void)setSendFilter:(CDUnknownBlockType)arg1 withQueue:(struct dispatch_queue_s *)arg2 isAsynchronous:(BOOL)arg3;
