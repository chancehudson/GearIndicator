...
- (id)zk_deflate;
- (id)zk_inflate;
- (unsigned long)zk_crc32:(unsigned long)arg1;
- (unsigned long)zk_crc32;
- (id)zk_stringOffsetBy:(unsigned long long *)arg1 length:(unsigned int)arg2;
- (BOOL)zk_hostBoolOffsetBy:(unsigned long long *)arg1;
- (unsigned long long)zk_hostInt64OffsetBy:(unsigned long long *)arg1;
- (unsigned long)zk_hostInt32OffsetBy:(unsigned long long *)arg1;
