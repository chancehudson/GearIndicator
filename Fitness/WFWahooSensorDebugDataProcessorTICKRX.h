...
@interface WFWahooSensorDebugDataProcessorTICKRX : WFAbstractWahooSensorDebugDataProcessor
{
}

- (void)unpackDebugMessage_AccelSampleSync;
- (void)unpackDebugMessage_AccelSamples;
- (void)unpackDebugMessage_HRInfo;
- (void)unpack;
