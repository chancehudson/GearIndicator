...
- (void)defineSourceGroups:(int *)arg1 total:(int)arg2;
- (BOOL)_setUpSourceGroups:(int *)arg1 total:(int)arg2;
- (BOOL)_redefineSourceGroups:(int *)arg1 total:(int)arg2;
...
- (void)_testGetGain;
- (BOOL)isSoundPlaying_WF:(unsigned int)arg1;
